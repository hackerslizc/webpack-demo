...
/******/ 	var hotCurrentHash = "4c99ec46145b771341f6"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentMode = React.createClass({ displayName: "ContentMode",
	    render: function () {
	        return React.createElement("div", { className: "ContentMode" }, React.createElement("div", { className: "contents" }, this.props.contents), this.props.children);
	    }
	});
	/* 页面div封装 上面三个模块 */
	var Page = React.createClass({ displayName: "Page",
	    render: function () {
	        return React.createElement("div", { className: "homepage" }, React.createElement(ContentMode, { contents: "longen" }, " this is one comment "), React.createElement(ContentMode, { contents: "longen2" }, "this is two comment"));
	    }
	});
	/* 初始化到content容器内 */
	ReactDOM.render(React.createElement(Page, null), document.getElementById("content"));

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(173); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "main.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
